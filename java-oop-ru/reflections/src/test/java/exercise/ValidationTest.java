...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Ufa", "Lennon", null, null);
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of("city", List.of(
                "length less than 4"),
                "houseNumber", List.of("can not be null")
        );
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("England", "London", "1-st street", "5", "1");
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of();
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", "New York", null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("country" , List.of(
                "length less than 5"),
                "houseNumber", List.of("can not be null"),
